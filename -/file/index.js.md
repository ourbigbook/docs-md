<h1 id="-/file/index.js">index.js</h1>
...
You should normally use the packaged `-/obb/ourbigbook.js` version of this file when using ourbigbook as an external dependency.
