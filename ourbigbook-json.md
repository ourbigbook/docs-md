...
Therefore, it is recommended that you always have a `ourbigbook.json` in your project's toplevel directory, even if it is going to be an empty JSON containing just:<a id="ourbigbook-json/_3738"></a>
...
For example, if you convert a file in a subdirectory such as:<a id="ourbigbook-json/_3740"></a>

```
ourbigbook subdir/notindex.bigb
```
then `ourbigbook` walks up the filesystem tree looking for `ourbigbook.json`, e.g.:<a id="ourbigbook-json/_3741"></a>

<a id="ourbigbook-json/_3742"></a>
- is there a `./subdir/ourbigbook.json`?
<a id="ourbigbook-json/_3743"></a>
- otherwise, is there a `./ourbigbook.json`?
<a id="ourbigbook-json/_3744"></a>
- otherwise, is there a `../ourbigbook.json`?
<a id="ourbigbook-json/_3745"></a>
- otherwise, is there a `../../ourbigbook.json`?
and so on.

<a id="ourbigbook-json/_3746"></a>
