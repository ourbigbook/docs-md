...
The correct approach is instead to actually re-extract server side as part of the migration. We should do this by implementing a `Article.reextract` analogous to `Article.rerender`, and a helper [web/bin/rerender-articles.js](-/file/web/bin/rerender-articles.js.md).
