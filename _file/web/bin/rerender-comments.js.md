<h1 id="_file/web/bin/rerender-comments.js">web/bin/rerender-comments.js</h1>

↑ **Parent:** [Web CLI utils](../../../web-cli-utils.md)

Analogous to [web/bin/rerender-articles.js](rerender-articles.js.md) but for comments.
