<h1 id="raw-files-are-downloaded-rather-than-displayed-in-browser-for-certain-file-extensions-on-github-pages"><code>-/raw</code> files are downloaded rather than displayed in browser for certain file extensions on GitHub Pages</h1>

↑ **Parent:** [`--publish-target github-pages`](publish-target-github-pages.md)  
🏷️ **Tags:** [`-/raw` directory](raw-directory.md)
