...
Certain commonly used macros have a shorthand macro syntax that do not start with backslash (`\`). It is a form of [syntactic sugar](https://ourbigbook.com/-/topic/syntactic-sugar).
