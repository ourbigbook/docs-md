...
The most common macros also have [macro shorthand syntaxes](macro-shorthand-syntax.md) to keep the syntax shorter.

The general macro syntax is described at [Section "OurBigBook Markup syntax"](ourbigbook-markup-syntax.md).
