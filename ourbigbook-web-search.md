...
OurBigBook Web supports basic search for [ID](element-id.md) prefixes of articles and [topics](ourbigbook-web-topics.md). Current search limitations:
...
**[Figure 62](#image-ourbigbook-web-search-demo). OurBigBook Web search demo**. Visible live at: [https://ourbigbook.com/-/articles?body=false&search=physics-and](https://ourbigbook.com/-/articles?body=false&search=physics-and)
...
**[Figure 63](#image-ourbigbook-web-search-highlighting-full-text-search). OurBigBook Web search highlighting full text search**. [Source](https://ourbigbook.com/-/articles?body=false&search=calculus%20fun).

Related:
- [https://github.com/ourbigbook/ourbigbook/issues/263](https://github.com/ourbigbook/ourbigbook/issues/263)
