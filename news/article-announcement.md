...
🏷️ **Tags:** [Article announcement](article-announcement.md), [`-W`, `--web`](../web.md)

It is now possible to send a link to one of your articles to all of your followers on [OurBigBook Web](../ourbigbook-web.md) with the [Article announcement](../article-announcement.md) feature. You can also add a short custom message to the announcement.
