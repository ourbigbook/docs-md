...
🏷️ **Tags:** [Scope](../h-scope-argument.md), [Static website](../p-publish.md), [`-W`, `--web`](../web.md)

Starting now, if you have a [scoped](../h-scope-argument.md) header such as `Sample code` in:
```
= x86 Paging
{scope}
...
- [static website](../p-publish.md): [https://cirosantilli.com/x86-paging/sample-code](https://cirosantilli.com/x86-paging/sample-code)
- [dynamic website](../ourbigbook-web.md): [https://ourbigbook.com/cirosantilli/x86-paging/sample-code](https://ourbigbook.com/cirosantilli/x86-paging/sample-code)
