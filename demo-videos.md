...
- music style guidelines: cool, beats, techno, mysterious, upbeat
  ...
  Some of the videos contain non-fully free YouTube music added via the YouTube UI. Reupload together with the video files appears however allowed. Ideally we should use fully [CC BY-SA](https://ourbigbook.com/-/topic/cc-by-sa) music, but it is quite hard to find good ones. NC is not acceptable.
