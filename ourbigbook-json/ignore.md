...
<a id="ourbigbook-json/_3758"></a>
Only ignores recursive conversions, e.g. given:<a id="ourbigbook-json/_3759"></a>
...
```
doing:<a id="ourbigbook-json/_3760"></a>

```
ourbigbook .
```
skips that directory, but<a id="ourbigbook-json/_3761"></a>
...
Examples:<a id="ourbigbook-json/_3763"></a>

<a id="ourbigbook-json/_3764"></a>
- ignore all files with a given extension;<a id="ourbigbook-json/_3765"></a>
