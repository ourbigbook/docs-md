...
For example:<a id="ourbigbook-json/_3928"></a>
...
<a id="ourbigbook-json/_3929"></a>
Absolute URLs are also accepted, e.g.:<a id="ourbigbook-json/_3930"></a>
...
<a id="ourbigbook-json/_3934"></a>
Unfortunately, GitHub Pages does not generate redirects like github.com itself.

<a id="ourbigbook-json/_3935"></a>
So in this case, we've added to the [`ourbigbook.json`](../ourbigbook-json.md) of the toplevel user repository [https://github.com/cirosantilli/cirosantilli.github.io](https://github.com/cirosantilli/cirosantilli.github.io) the lines:<a id="ourbigbook-json/_3936"></a>
