...
<a id="ourbigbook-json/_3809"></a>
Possible values:<a id="ourbigbook-json/_3810"></a>

<a id="ourbigbook-json/_3811"></a>
- `parent`: forces headers to use [`\H` `parent` argument](../h-parent-argument.md) to specify their level
<a id="ourbigbook-json/_3812"></a>
