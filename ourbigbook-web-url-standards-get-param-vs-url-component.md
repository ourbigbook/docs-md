...
- tristate booleans are:
  ...
  - [http://localhost:3000/-/users?locked=0](http://localhost:3000/-/users?locked=0): show only unlocked users. Same as the default [http://localhost:3000/-/users](http://localhost:3000/-/users).
  - [http://localhost:3000/-/users?locked=1](http://localhost:3000/-/users?locked=1): show only locked users.
  - [http://localhost:3000/-/users?locked=2](http://localhost:3000/-/users?locked=2): show both locked and unlocked users.

  The user list also hides users without verified email by default:
  - [http://localhost:3000/-/users?verified=1](http://localhost:3000/-/users?verified=1): show only users with verified email. Same as the default [http://localhost:3000/-/users](http://localhost:3000/-/users).
  - [http://localhost:3000/-/users?verified=0](http://localhost:3000/-/users?verified=0): show only users with unverified email.
  - [http://localhost:3000/-/users?verified=2](http://localhost:3000/-/users?verified=2): show users with both verified and unverified email.
