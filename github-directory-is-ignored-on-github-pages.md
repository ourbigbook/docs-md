...
It's a GitHub bug/feature: [https://github.com/orgs/community/discussions/52252](https://github.com/orgs/community/discussions/52252)

Maybe we should just ignore the `.github` directory when publishing, otherwise it leads to a broken link on the [`-/dir` directory](dir-directory.md) listings.
