...
- Run [https://cirosantilli.com/-/raw/wikipedia/sqlite_preorder.py](https://cirosantilli.com/-/raw/wikipedia/sqlite_preorder.py), potentially differently parametrized, as:
  ```
  rm -rf out
